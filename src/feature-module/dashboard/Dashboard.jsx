...
const Dashboard = () => {
  const [chartOptions] = useState({
    series: [
      { name: "Credits", data: [130, 210, 300, 290, 150, 50, 210, 280, 105] },
      { name: "Debits", data: [-150, -90, -50, -180, -50, -70, -100, -90, -105] },
    ],
  ...
  return (
    <>
      ...
      <div className="row mt-3">
        {[
          { value: 100, label: "Customers", icon: <User /> },
          { value: 35, label: "Murabaha Clients", icon: <UserCheck /> },
          { value: 45, label: "Fixed Deposit Accounts", icon: <File /> },
          { value: 10, label: "Closed Accounts", icon: <File /> },
        ].map((item, idx) => (
          <div key={idx} className="col-xl-3 col-sm-6 col-12 d-flex">
            <div
      ...
      <div className="row mt-4">
        <div className="col-xl-7 col-sm-12 d-flex">
        ...
        <div className="col-xl-5 col-sm-12 d-flex">
          <div className="card flex-fill">
